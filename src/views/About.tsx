...
const About = () => {
  return (
    <div id="about" className="w-full px-[10%] py-10">
        ...
        <div className="flex flex-col">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
            {infoList.map((info, index) => (
              <li
                className="border-[0.5px] border-gray-400 rounded-xl p-6  hover:bg-gray-100 hover:-translate-y-1 duration-500 group"
                key={index}
              >
                <Image
                  src={info.icon}
